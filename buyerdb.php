...
function insertUser($buyer_fname,$buyer_lname,$b_uname,$b_mbl_no,$b_email,$b_pass,$b_dob,$b_gender,$buyer_table,$conn)
    {
    ...
    $sqlstr="INSERT into $buyer_table (b_fname,b_lname,b_uname,b_mbl_no,b_email,b_pass,b_dob,b_gender,premium_check) 
    VALUES ('$buyer_fname','$buyer_lname','$b_uname',$b_mbl_no,'$b_email','$b_pass','$b_dob','$b_gender','no')";
...
function UpdateUser($first,$last,$user,$mobile,$email,$password,$dob,$table,$conn)
 ...
 function updatedp($conn,$table,$username){
    $sql = "UPDATE $table WHERE b_uname='$username' ";
